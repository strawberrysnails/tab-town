# Tab Town
* Heavily inspired by [catppuccin-startpage](https://github.com/pivoshenko/catppuccin-startpage)
...
# Usage
Open a new tab. Scroll or use the tab buttons to switch pages. Click ⚙ to open settings and add/remove bookmarks.
